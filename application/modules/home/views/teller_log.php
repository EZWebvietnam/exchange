                        ...
                        <a>
                            <div class="NoneStyleDiv">
                                ...
                                <div class="tinhtrangStyle">
                                    ...
                                    <div style="width:104px;" align="left">&nbsp;<span>Chưa xác nhận</span></div>
                                    <?php } else {?>
                                    <div class="divIcon finishIcon"></div>
                                    <div style="width:104px;" align="left">&nbsp;<span>Đã xác nhận</span></div>
                                    <?php } ?>
                                </div>
                                <div class="tinhtrangStyle">
                                    <?php 
                                    if($transaction['admin_acept']==0)
                                    {
                                    ?>
                                    <div class="divIcon debitMoneyIcon"></div>
                                    <div style="width:104px;" align="left">&nbsp;<span>Đang chờ</span></div>
                                    <?php } else {?>
                                    <div class="divIcon finishIcon"></div>
                                    <div style="width:104px;" align="left">&nbsp;<span>Đã chuyển</span></div>
                                    <?php } ?>
                                </div>
                                <div class="thoigianStyle" align="right">
                                    <?php echo date('d/m/Y',$transaction['create_date']);?>
                                </div>
                            </div>
                        </a>
                        <?php }?>

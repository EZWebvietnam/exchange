...
class Productctvmodel extends CI_Model
{
    ...
    public function list_product($id_user,$number,$offset)
    {
        ...
        $sql ="SELECT *,user_product.id as user_product_id FROM user_product INNER JOIN product ON user_product.id_product = product.id_product INNER JOIN cate_product ON product.id_cate = cate_product.id_cate WHERE user_product.id_user = $id_user LIMIT $offset,$number";
        $query = $this->db->query($sql);
        return $query->result_array();
    }
    ...
    {
        $id_user = intval($id_user);
        $sql ="SELECT *,user_product.id as user_product_id,cate_product.id_cate,cate_product.name FROM user_product INNER JOIN product ON user_product.id_product = product.id_product INNER JOIN cate_product ON product.id_cate = cate_product.id_cate WHERE user_product.id_user = $id_user";
        $query = $this->db->query($sql);

 ...
 *
 * Keyboard Credits
 *   - Swedish keyboard layout by H䪡n Sandberg
...
Modified by SINT
*/ 
var src_img = IMG_URL+"/libs/images/keyboard.png";
var src_img_zingid = IMG_URL+"/libs/images/gbid.gif";
    ...
    this.VKI_position = function() {
      if (self.VKI_visible) {
        ...
        if (self.VKI_isIE6) {
          ...
          self.VKI_iframe.style.left = self.VKI_keyboard.style.left-rnd;
        }
      }
    };
